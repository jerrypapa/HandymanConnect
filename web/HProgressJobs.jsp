    ...
    <div class="row">
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
            <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                <h1 class="h2">In-progress Jobs</h1>
            </div>
            <div class="container w-100">
                ...
                <div class="container">
                    <ul class="list-group">
                        ...
                        %>
                        <a href="HandymanServlet?ProgressJob=<%=jobsList.get(i).getJobId()%>" class="list-group-item list-group-item-action"><%=jobsList.get(i).getJobName()%>&nbsp;offered by&nbsp;<%=jobsList.get(i).getCustomerName()%> </a>
                        <%
                            }
                        %>
                    </ul>
                ...
                <%
                            ...
                            out.println("You have no jobs in progress!");
                        }
                    }
                %>
            </div>
