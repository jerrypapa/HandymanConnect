...
<%@ page import="Messages.AdminCustomer" %>
...
<%
    ...
    if(admin==null){
        ...
        List<AdminCustomer> textList=(List<AdminCustomer>)request.getAttribute("messages");
        if(textList.size()>0){
...
<div class="container-fluid">
    <div class="row">
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
            ...
            <div class="w-100">
                <div>
                    <a href="AdminServlet?Messages=ok#customers" class="btn btn-outline-primary"><span class="fa fa-arrow-left"></span>&nbsp;Back</a>
                </div>
                <br/>
                ...
                <form action="AdminServlet2" method="post" id="message_form">
                    <input type="hidden" name="admin_msg" value="to_customer"/>
        ...
        $('#message_form').on('submit',function (e) {
            ...
            $.ajax({
                ...
                success: function (result) {
                    if(result!=null){
                        $('#p2').hide();
                        window.open('AdminServlet?C_ChatID='+result,'_self');
                    }
                },
                error: function () {
                    //alert("Something went wrong-!");
