...
<%@ page import="Messages.AdminHandyman" %>
...
<%
    ...
    if(admin==null){
        ...
        List<AdminHandyman> textList=(List<AdminHandyman>)request.getAttribute("messages");
        if(textList.size()>0){
            for (int i=0;i<textList.size();i++){
                if(textList.get(i).getSender_type().equalsIgnoreCase("handyman")){
                    handymanId=textList.get(i).getId();
                }
            }
        }else{
...
<div class="container-fluid">
    <div class="row">
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
            ...
            <div class="w-100">
                <div>
                    <a href="AdminServlet?Messages=ok#handymen" class="btn btn-outline-primary"><span class="fa fa-arrow-left"></span>&nbsp;Back</a>
                </div>
                <br/>
                      ...
                      <div class="card-body">
                        ...
                        %>
                                <div><div class="card" style="text-align: right;padding: 5px;color: blue;width: fit-content;">
                                    ...
                                    <div><%=textList.get(i).getDate_sent()%></div>
                                </div></div><br/><br/>
                        <%
                            }else if(textList.get(i).getSender_type().equalsIgnoreCase("handyman")){
                ...
                <form action="AdminServlet2" method="post" id="message_form">
                    ...
                    <input type="hidden" name="handyman_id" value="<%=handymanId%>"/>
