            ...
            <div class="container w-100">
                ...
                <div class="container">
                    <ul class="list-group">
                        ...
                        %>
                        <a href="HandymanServlet?PendingJob=<%=jobsList.get(i).getJobId()%>" class="list-group-item list-group-item-action"><%=jobsList.get(i).getJobName()%>&nbsp;offered by&nbsp;<%=jobsList.get(i).getCustomerName()%> </a>
                        <%
                            }
                        %>
                    </ul>
                ...
                <%
                            ...
                            out.println("There are no pending jobs!");
                        }
                    }
                %>
            </div>
