    ...
    <div class="row">
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
            <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                <h1 class="h2">Handyman job details</h1>
            </div>
            <%
            ...
            <div class="container-fluid w-100 card">
                <div class="card-body">
                    <ul class="list-group">
                        ...
                        <li class="list-group-item">
                            <div class="container">
                                <b>Handyman job description:</b>&nbsp;<br/>
                                <ul class="list-group w-75">
                                    <%
                                        for (int j=0;j<jobsList.size();j++){
                                    %>
                                    <li class="list-group-item">
                                        Job name:&nbsp;<span style="color: rgba(17,58,255,0.9)"><%=jobsList.get(j).getJobName()%></span>
                                    </li>
                                    <li class="list-group-item">
                                        Offered by&nbsp;<span style="color: rgba(17,58,255,0.9)"><%=jobsList.get(j).getCustomerName()%></span>
                                    </li>
                                    <li class="list-group-item">
                                        Job description:&nbsp;<span style="color: rgba(17,58,255,0.9)"><%=jobsList.get(j).getJobDescription()%></span>
                                    </li>
                                    <li class="list-group-item">
                                        Date placed:&nbsp;<span  style="color: rgba(17,58,255,0.9)"><%=jobsList.get(j).getDatePlaced()%></span>
                                    </li>
                                    <li class="list-group-item">
                                        Status:&nbsp;<span  style="color: rgba(17,58,255,0.9)"><%=jobsList.get(j).getStatus()%></span>
                                    </li>
                                    <%
                                        }
                                    %>
