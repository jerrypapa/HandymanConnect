            ...
            <div class="container-fluid w-100 card">
                <div class="card-body">
                    <ul class="list-group">
                            ...
                            <div class="container">
                                ...
                                <%
                                    if(handymen.getStatus().equalsIgnoreCase("suspended")){
                                        out.println("<a href='AdminServlet?unsuspendadmin="+handymen.getHandymanid()+"' class='btn btn-outline-success btn-sm'>Lift suspension</a>");
                                    }else if(handymen.getStatus().equalsIgnoreCase("active")){
                                        out.println("<a href='AdminServlet?suspendadmin="+handymen.getHandymanid()+"' class='btn btn-outline-danger btn-sm'>Suspend</a>");
                                    }
                                %>
                                </span>
                            </div>
                        ...
                        <li class="list-group-item">
                            <div class="container">
                                <b>E-mail Address:</b>&nbsp;<%=handymen.getEmail()%>
                            </div>
                        </li>
                        <li class="list-group-item">
                            <div class="container">
                                <b>Phone:</b>&nbsp;<%=handymen.getPhoneNo()%>
                            </div>
                        </li>
                        <li class="list-group-item">
                            <div class="container">
                                <b>Location:</b>&nbsp;<%=handymen.getLocation()%>
                            </div>
                        </li>
                        <li class="list-group-item">
                            <div class="container">
                                <b>Gender:</b>&nbsp;;<%=handymen.getGender()%>
                            </div>
                        </li>
                        <li class="list-group-item">
                            <div class="container">
                        ...
                        <li class="list-group-item">
                            <div class="container">
                                ...
                                %>
                                    <li class="list-group-item"><%=postsList.get(j).getName()%></li>
                                <%
                                }
                                %>
                                </ul>
