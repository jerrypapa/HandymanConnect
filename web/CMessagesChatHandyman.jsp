...
<%
    ...
    if(customer==null){
        ...
        int handyman_id=Integer.parseInt((String)request.getAttribute("handyman_id"));
    ...
    <div class="row">
        <nav class="col-md-2 d-none d-md-block bg-light sidebar">
            <div class="sidebar-sticky">
                <ul class="nav flex-column">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="UserProfiling.jsp">
                            <span data-feather="home"></span>
                            My Profile <span class="sr-only">(current)</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="CustomerServlet?HandyMenList=ok">
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
            <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                <h1 class="h2">Handymen Chat List</h1>
            </div>
            <div class="w-75 container-fluid">
                ...
                out.println("<div class='w-100 card' style='height: 500px;overflow-y: scroll;'><div class='card-body'>");
                    for (int i=0;i<handyManMessagingList.size();i++){
                        ...
                        out.print("<div>"+handyManMessagingList.get(i).getSender_name()+"</div>");
                        out.print("<div>"+handyManMessagingList.get(i).getMessage()+"</div>");
                        out.print("</div></div>");
                    }
                out.println("</div></div>");
                }
            ...
            <div>
                <form action="CustomerServlet" method="post" id="message_form">
                    <input type="hidden" name="customer_msg" value="customer_msg"/>
                    <input type="hidden" name="handyman_id" value="<%=handyman_id%>"/>
