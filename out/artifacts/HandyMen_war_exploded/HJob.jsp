    ...
    <div class="row">
        <nav class="col-md-2 d-none d-md-block bg-light sidebar">
            <div class="sidebar-sticky">
                <ul class="nav flex-column">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="HandymanServlet?PendingJobs=ok">
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
            <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                <h1 class="h2">Pending Job Description</h1>
            </div>
                            ...
                            <div class="container">
                                <form action="HandymanServlet" method="get" id="responseForm">
                                    <div class="row">
                                        ...
                                        <input type="hidden" name="start_job" value="inprogress" />
                                        <label class="control-label col-4">By clicking agree you choose to do this job!</label>
                                        <div class="col-8">
                                            <button type="submit" class="btn btn-outline-success">Agree</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
