...
<%
    ...
    Handymen handymen=(Handymen)httpSession.getAttribute("logged_handymen");
%>
<html>
<head>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Welcome||Handyman&nbsp;<%//=handymen.getUsername()%></title>
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu dropdown-messages">
                    <li>
                        <a href="#">
                            <div>
                                <strong><span class=" label label-danger">Handyman</span></strong>
                    ...
                    <li>
                        <a href="#">
                            <div>
                                <strong><span class=" label label-info">Handyman</span></strong>
                                <span class="pull-right text-muted">
                                        <em>Yesterday</em>
                                    </span>
                            </div>
                    ...
                    <li>
                        <a href="#">
                            <div>
                                <strong><span class=" label label-success"></span></strong>
                                <span class="pull-right text-muted">
                                        <em>Yesterday</em>
                                    </span>
                            </div>
            ...
            <ul class="nav" id="side-menu">
                <li>
                    ...
                    <div class="user-section">
                        ...
                        <div class="user-info">
                            <div><%=handymen.getUsername()%>&nbsp;<%=handymen.getLastName()%></div>
