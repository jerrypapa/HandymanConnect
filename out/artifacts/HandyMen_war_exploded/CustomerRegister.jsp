...
<div class="container">
    ...
    <form class="form-horizontal" action="CustomerRegisterServlet" method="post"  id="contact_form">
        <fieldset>

            <!-- Form Name -->
            <legend><center><h2><b>Customers Registration Form</b></h2></center></legend><br>
