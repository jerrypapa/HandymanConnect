            ...
            <div class="w-75 container-fluid">
                <ul class="list-group">
                    ...
                    for(int i=0;i<handymenList.size();i++){
                        out.println("<a href='CustomerServlet?Chat="+handymenList.get(i).getHandymanid()+"' class='list-group-item list-group-item-action'>"+handymenList.get(i).getUsername()+"</a>");
                    }
                    %>
                </ul>
            </div>
